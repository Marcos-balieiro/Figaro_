...
public class ConsultaSelenium extends LoginTRF {
    ...
    private String nomeDaParte  = null;
    ...
    public void setEnderecos() {
         ...
         if(TRF.equals("TRF1")){
            ...
            nomeDaParte = "fPP:j_id143:nomeParte";
            EnderocoClasse = "fPP:j_id250:classeJudicial";
            EnderecoAssunto = "fPP:j_id241:assunto";
            ...
            nomeDaParte = "fPP:j_id150:nomeParte";
   ...
   TriagemSelenium filtro = new TriagemSelenium();
    ...
    public void irnserirParmetros(String nome, String assunto, String classe, String grupo, String janelaPadrao, String data_fin, String dataInicio) {
        ...
        String idnomeparte = nomeDaParte;
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(polopassivo)));
