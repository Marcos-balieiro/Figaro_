...
public class SeleniumTRF1<usuario> {
    ...
    public Vector exceções2(String janelapadrao, String nome, String TRF) throws InterruptedException, AWTException {
        ...
        public Vector<String> pesquisa2 (String janelapadrao, String nome, String TRF) throws
        ...
        public Vector<String> pesquisaMunicipio (String janelapadrao, String nome, String TRF) throws
        InterruptedException, AWTException {
            if (TRF == "TRF6") {
